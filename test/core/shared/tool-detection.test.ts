...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('enpalspec-explore');
      expect(SKILL_NAMES).toContain('enpalspec-new-change');
      expect(SKILL_NAMES).toContain('enpalspec-continue-change');
      expect(SKILL_NAMES).toContain('enpalspec-apply-change');
      expect(SKILL_NAMES).toContain('enpalspec-ff-change');
      expect(SKILL_NAMES).toContain('enpalspec-sync-specs');
      expect(SKILL_NAMES).toContain('enpalspec-archive-change');
      expect(SKILL_NAMES).toContain('enpalspec-bulk-archive-change');
      expect(SKILL_NAMES).toContain('enpalspec-verify-change');
      expect(SKILL_NAMES).toContain('enpalspec-onboard');
      expect(SKILL_NAMES).toContain('enpalspec-propose');
    });
  });
  ...
  describe('getToolSkillStatus', () => {
    ...
    it('should detect when one skill exists', async () => {
      const skillDir = path.join(testDir, '.claude', 'skills', 'enpalspec-explore');
